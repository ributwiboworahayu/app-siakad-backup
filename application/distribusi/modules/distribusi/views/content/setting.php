        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group pb-2">
                    <label for="takad">Tahun Akademik</label>
                    <input type="hidden" id="takadid" name="takadid" readonly value="<?= $ta->id_thnakad ?>">
                    <input type="text" class="form-control" readonly value="<?= $ta->thun_akademik ?>">
                </div>
                <div class="form-group">
                    <div class="form-check pl-4">
