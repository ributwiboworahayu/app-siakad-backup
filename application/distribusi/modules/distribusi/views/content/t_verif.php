    ...
    <?php if ($vstatus->status_submit != 0) : ?>
        ...
        <div class="card-header">
            ...
            <?php if ($vstatus->status_submit == 1 && $vstatus->status_baak == 0) : ?>
                ...
                <a href="<?= base_url('distribusi/verifikasibaak/' . $prodiid) ?>" class="btn btn-sm btn-warning">Verifikasi</a>
            <?php elseif ($vstatus->status_submit == 1 && $vstatus->status_baak == 1 || $vstatus->status_direktur == 1) : ?>
                <a href="<?= base_url('distribusi/unduhskprodi/' . $prodiid) ?>" class="btn btn-warning" target="_blank"><i class="far fa-file-pdf"></i>unduh PDF</a>
            <?php endif ?>
        </div>
        <div class="card-body">
