<?php if ($vstatus != null) : ?>
    <?php if ($vstatus->status_submit != 0) : ?>
        ...
        <div class="card-header">
            ...
            <?php if ($vstatus->status_baak == 1 && $vstatus->status_wadir == 0) : ?>
                <a href="" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#TolakVerifikasiModal">Tolak</a>
                <a href="" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#VerifikasiModal">Verifikasi</a>
            <?php endif ?>
        </div>
        <div class="card-body">
        ...
        <div class="modal fade" id="TolakVerifikasiModal" tabindex="-1" aria-labelledby="TolakVerifikasiModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <?= form_open(base_url() . 'distribusi/tolakverifwadir'); ?>
        ...
        <div class="modal fade" id="VerifikasiModal" tabindex="-1" aria-labelledby="VerifikasiModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Kirim Distribusi Beban Ajar ke Direktur?
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                        <a href="<?= base_url('distribusi/diverifikasiwadir/' . $prodiid) ?>" class="btn btn-warning">Kirim</a>
                    </div>
                </div>
            </div>
        </div>
