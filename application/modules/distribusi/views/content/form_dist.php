                            ...
                            <td>
                                ...
                                <div class="form-inline">
                                    <div class="form-group">
                                        ...
                                        $dstrlb = set_mkselect($mhs['id_kelas'], $mk['id'], 'r_distribusi_lb', 1);
                                        ?>
                                        <select class="form-control" id="dosenpk<?= $mhs['id_kelas'] . $mk['id'] ?>" name="dosenpk[]">
                                            ...
                                            <?php foreach ($dosenlb as $dlb) : ?>
                                                <?php if ($dlb->id == $dstrlb->dosen_lb_id) : ?>
                                                    <option value="<?= $mhs['id_kelas'] ?>:<?= $mk['id'] ?>:dlb:<?= $dlb->id; ?>" selected><?= $dlb->namadosen ?></option>
                                                <?php else : ?>
