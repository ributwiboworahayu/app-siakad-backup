...
class Distribusi_model extends CI_Model
{
    ...
    public function getAllKurikulum($psid)
    {
        return $this->db->get_where('r_kurikulum', ['prodi_id' => $psid]);
    }
    ...
    public function getAllLBdist($prodiid)
    {
        $this->db->group_by('r_distribusi_lb.dosen_lb_id');
        return $this->db->get_where('r_distribusi_lb', ['prodi_id' => $prodiid]);
    }
