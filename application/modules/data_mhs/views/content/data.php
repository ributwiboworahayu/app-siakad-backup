...
<div class="modal fade" id="modal-add" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      <div class="modal-header bg-info">
        <h4 class="modal-title">Add New Mahasiswa</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
       <?= form_open(base_url().'data_mhs/save', array('id' =>"mhs" ,'class'=>"mhs" )); ?>
       <input type="hidden" name="id_mhs" id="id_mhs" value="">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
         ...
         <!--  <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="file" class="form-control" id="photo" name="photo" placeholder="Enter email">
  ...
  <script  type="text/javascript" >
    ...
    $('tbody').on('click', '.btn-edit', function(event) {
      event.preventDefault();
        ...
        $('#method').val('edit');
        $.ajax({
          url: '<?=base_url()?>data_mhs/getmhsid',
          type: 'GET',
          dataType: 'JSON',
          data: {id: id},
          success : function(result) {
            ...
            $('#semester').val(result.semester_id);
          }
        })
    });
  ...
  $("#table tbody").on("click", "tr .check", function() {
   ...
   $("#bulk").on("submit", function(e) {
    if ($(this).attr("action") =="<?=base_url()?>data_mhs/delete") {
      e.preventDefault();
      e.stopImmediatePropagation();
  ...
  if ($("#table tbody tr .check:checked").length == 0) {
    ...
    $("#bulk").attr("action", "<?=base_url()?>data_mhs/delete");
    Swal.fire({
      icon:"warning",
      title: "Anda yakin?",
