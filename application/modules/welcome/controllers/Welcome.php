...
class Welcome extends CI_Controller
{
	...
	public function insertKlas()
	{
		$mail = ['andrinf@poltek-kampar.ac.id', 'rahmad.abr@poltek-kampar.ac.id', 'adifebri@poltek-kampar.ac.id', 'fatma@gmail.com', 'wahyuni@gmail.com', '	romi@gmail.com', 'fenty@gmail.com'];
		...
		$this->db->insert_batch('user_trakses', $data);
		$this->output->set_content_type('application/json')->set_output(json_encode($data));
	}

	public function GenPassw($pj)
	{
