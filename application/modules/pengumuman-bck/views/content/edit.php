					...
					<div class="j-content">
								...
								<label class="j-input j-select">
									<select name="akademik" id="akademik">
										...
										<?php foreach ($akd as $akd):?>
											<?php $is_select = ($akd->id_thnakad == $data->akademik_id) ? "selected" : ""; ?>
											<option value="<?=$akd->id_thnakad?>" <?=$is_select?>><?=$akd->thun_akademik?> - <?=$akd->ta_tipe?> </option>
										<?php endforeach?>
									</select>
									<i></i>
								</label>
						...
						<div class="j-unit">
							...
							<div class="j-input">
								...
								<input type="text" id="no_surat" name="no_surat" value="<?=$data->no_pengumuman?>">
							</div>
						</div>
						<!-- end date -->
						...
						<div class="j-unit">
							...
							<div class="j-input">
								<textarea spellcheck="false" name="isi" class="ckeditor" id="ckeditor"><?=$data->isi_pengumuman?></textarea>
							</div>
						</div>
						<!-- end message -->
