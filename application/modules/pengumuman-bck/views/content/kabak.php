                    ...
                    <div class="col-xl-12">
                      <div class="card">
                        <div class="card-header">
                          ...
                          <hr>
                          <input type="hidden" name="filter_kabak" id="filter_kabak" value="0">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <input type="hidden" name="r_field" id="r_field" value="kabak">
  ...
  $(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
      ...
      "serverSide": true,
            ...
            "ajax": {
              "url": "<?=base_url()?>pengumuman/tables_kabak",
              "type": "POST",
              "data": function ( data ) {
        ...
        $.ajax({
            ...
            success: function (response) {
               if (response.status) {
                Swal.fire(
                'Success!',
                'Review Berhasil Di simpan Dan di kirim ke Operator',
                'success'
                )
                 $('#modal-id').modal('hide');
               }
    ...
    $('tbody').on('click','.btn-snk',function(event) {
      event.preventDefault();
      const id=$(this).attr('data');
      const val=1;
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            url: '<?=base_url()?>pengumuman/val_kabak',
            type: 'POST',
            dataType: 'json',
            data: {id:id,val:val},
