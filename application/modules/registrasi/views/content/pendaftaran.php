  ...
  <div class="card-block box-list"> -->
    ...
    <div class="row" id="display-after" <?=$ui['dis_after']?> >
      <div class="col-sm-6">
        <div class="p-20 z-depth-0 waves-effect">
          <?= form_open(base_url().'registrasi/savependaftaran',['id'=>'form-reg']); ?>
            ...
            <span id="btn-dt"><?=$ui['dis_btn']?></span>
      ...
      <div class="col-sm-6">
        <div class="p-20 z-depth-0 waves-effect">
          <div class="container">
            <h1 id="headline5">Waktu Pendaftaran Akan Berakhir Dalam</h1>
            ...
            <h1 id="headline1">Silahkan Lakukan Pendaftaran</h1>
          </div>
        </div>
      </div>
    </div>
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    clearInterval(x);
    $('#headline5').css('display', 'none');
    $('#headline1').css('display', 'none');
    $('#btn-dt').css('display', 'none');;
