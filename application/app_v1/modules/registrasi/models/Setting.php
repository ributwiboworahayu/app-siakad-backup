...
class Setting extends CI_Model {
	...
	{
		$sql="SELECT id_setting,thn_akd,tgl_mulai,tgl_bts_reg,tgl_selesai,status, CASE WHEN NOW() < tgl_mulai THEN '0' WHEN NOW() >= tgl_mulai AND NOW() <= tgl_bts_reg THEN '1' ELSE '2' END AS stt FROM ru_setting WHERE status=1";
